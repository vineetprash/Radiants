    ...
    <div className="bg-light min-h-screen">
      ...
      <section className="flex justify-center items-center py-16 min-h-[80vh]">
        <div className="text-center px-4 max-w-2xl">
          <div className="text-2xl text-gray-500 font-medium">Welcome to</div>
          <div className="pointer-events-none  bg-gradient-to-b from-black to-gray-400 bg-clip-text text-center text-6xl font-bold leading-none text-transparent ">
            PCCoE Events Console
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 flex justify-center items-center">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            {[
              ...
              >
                <p className="mb-6 font-bold text-xl">{feature.title}</p>
                <img
                  src={feature.img}
                  alt={feature.title}
      ...
      {/* Some Section */}
      <section className="bg-light py-12 h-[500px]">
        <InfiniteCarousel />
      </section>

      {/* Footer */}
      <footer className="bg-accent1 mt-12 h-[200px] text-white text-center py-6">
